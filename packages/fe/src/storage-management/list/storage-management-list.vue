...
<template>
	<div class="wrapper">
        ...
        <el-button class="add-button" type="primary" @click="addNewStorageLocation">Add New Storage Location</el-button>
            ...
            <el-table-column width="80">
				<template #default="{ row }">
                    <el-tooltip
                        ...
                        placement="top-end"
                    >
					    <el-button @click="() => editStorageLocation(row.id)"><rh-icon name="pencil" /></el-button>
                    </el-tooltip>
				</template>
			</el-table-column>
			<el-table-column width="80">
